...
public class UpdateData extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cursor = db.rawQuery("SELECT * FROM hamil WHERE nama = '" +
        ...
        ton1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                db.execSQL("update hamil set nama='"+
                        text2.getText().toString() +"', alamat='" +
                        text3.getText().toString()+"', tensi='"+
                        text4.getText().toString() +"', berat='" +
                        text5.getText().toString() +"', bayi='" +
                        text6.getText().toString() +"', kandungan='" +
